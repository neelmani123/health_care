class ClientProfileModel {
  ...
  ClientProfileModel({this.result, this.message, this.user});

  ClientProfileModel.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    message = json['message'];
    user = json['user'] != null ? new CleintUser.fromJson(json['user']) : null;
  }
...
class CleintUser {
  ...
  CleintUser.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
