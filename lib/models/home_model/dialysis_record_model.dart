class DailysisRecordModel {
  ...
  DailysisRecordModel.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    message = json['message'];
    if (json['prescriptions'] != null) {
      prescriptions = <DailysisRecordPrescriptions>[];
      json['prescriptions'].forEach((v) {
        prescriptions!.add( DailysisRecordPrescriptions.fromJson(v));
      });
    }
    page = json['page'];
  }
...
class DailysisRecordPrescriptions {
  var id;
  var userId;
  var file;
 var title;
