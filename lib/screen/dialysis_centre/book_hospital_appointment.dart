...
class BookHospitalAppointment extends StatefulWidget {
  final hospitalId;
  const BookHospitalAppointment({super.key,this.hospitalId});
...
class _BookHospitalAppointmentState extends State<BookHospitalAppointment> {
  ...
  void dialysisCentreDetailsApi()async{
    ...
    final res=await httpServices.dialysisCentreDetailsApi(hospitalId: widget.hospitalId.toString());
    if(res!.result==true)
    {
      setState(() {
    ...
    return Scaffold(
      bottomNavigationBar: Padding(
        ...
        child: CustomUi.primaryButton('Book Now', () {
          Get.to(BookDialysisslotsScreen(id: dialysisDetails.id.toString(),image: dialysisDetails.image.toString(),bio: dialysisDetails.description.toString(),name: dialysisDetails.name.toString(),type: 'dialysis',));
        }, 11,
              ...
              Expanded(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                       ...
                       image: DecorationImage(image: NetworkImage(dialysisDetails.image.toString()))),
                  )),
              ...
              Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomText(
                        text:
                        dialysisDetails.description.toString(),
          ...
          Row(
            ...
            children: [
              Row(
                ...
                children: [
                  CustomText(text:  dialysisDetails.totalRatings.toString(),color: const Color(0xFF3C3C3C),fontSize: 10,fontWeight: FontWeight.w400,),
