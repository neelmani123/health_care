...
class _ClientDialysisAppointmentState extends State<ClientDialysisAppointment>
  ...
  void updateAppointment(String aapointmentID,String slotTime,String date,String status)async
  {
    var res=await httpClientServices.clientUpdateAppointmentApi(status: status,date: date,appointment_id: aapointmentID,slot_time: slotTime);
    if(res!.result==true)
      {
        setState(() {
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20),
                             image: DecorationImage(image: NetworkImage(appointments[index].image.toString(),),fit: BoxFit.cover
                             )
                          ),
                        ),
                        Align(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(10),
                              border: Border.all(color:Color(0xFFA5A5A5),width: 2)
                            ),
                            child: Text(appointments[index].slotTime.toString(),style: TextStyle(fontSize: 8,color: AppColors.whiteColor),textAlign: TextAlign.center,)
                          ),
                        )
                      ],
                    )),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            DesignConfig.space(w: 2.w),
                            CustomText(
                              text: 'Last Dialysis(${appointments[index].lastDialysisDate.toString()})',
                              fontWeight: FontWeight.w400,
                              color: Color(0xFF7A7A7A),
                              fontSize: 10,
                            )
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: (){
                                updateAppointment(appointments[index].id.toString(),'','','3');
                              },
                              child: Container(
                                width: MediaQuery.of(context).size.width / 3.5,
                                height: 35,
                                ...
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(4),
                                    border: Border.all(
                                        color: Color(0xFFFF5050), width: 1)),
                                child: CustomText(
                                  text: 'Decline',
                                  fontWeight: FontWeight.w500,
